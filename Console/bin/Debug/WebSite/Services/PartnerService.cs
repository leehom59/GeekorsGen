...
namespace JamZooMng.Services
{
    ...
    public class PartnerService : BaseService
    {
        ...
        public static PARTNER Mapping(PartnerModel p)
        {
			...
			result.CIMAGE = p.Cimage;
			result.CDESC = p.Cdesc;
			result.LINK = p.Link;
        ...
        public PartnerModel Get(string id)
        {
            ...
            PARTNER Data = _repository.List<PARTNER>().Where(p => p.ID == _key).FirstOrDefault();
        ...
        public bool Update(PartnerModel entity)
        {
            ...
            if (dbEntity != null)
            {
				...
				dbEntity.CIMAGE = entity.Cimage;
				dbEntity.CDESC = entity.Cdesc;
